...
import { Post, Prisma, User } from "../../../prisma/src/generated/prisma/client";
...
export class PostsMapper{
    ...
    static toCreateInput(dto: CreatePostDto, authorId: string, productId: string): Prisma.PostUncheckedCreateInput{
        return {
            title: dto.title,
            rating: dto.rating,
            comment: dto.comment,
    ...
    static toResponseDto(post: Post & { author: Pick<User, 'id' | 'first_name' | 'last_name'> }): ResponsePostDto{
        return {
            postId: post.post_id,
            title: post.title,
            rating: post.rating,
